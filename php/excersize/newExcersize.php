...
if(isset($_POST['btn-addexcersize'])){
	...
	$excersize_type = htmlspecialchars(trim(strip_tags($_POST['excersizetype'])));
	$excersize_reps = htmlspecialchars(trim(strip_tags($_POST['excersizerep'])));
	$excersize_sets = htmlspecialchars(trim(strip_tags($_POST['excersizeset'])));
	...
	$excersize->createExcersize($_SESSION['user_session'], $excersize_type, $excersize_reps, $excersize_sets, $excersize_weight, $excersize_date);
